...
/**
 * Created by wangshy on 17/2/9.
 */

public class TaView extends View implements View.OnClickListener {
    ...
    public TaView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TaView(Context context, AttributeSet attrs, int defStyleAttr) {
